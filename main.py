...
from api.auto_ops import router as auto_ops_router
...
async def lifespan(app: FastAPI):
    ...
    from application.auto_ops import auto_ops_manager
    auto_ops_manager.start()
    yield
    from application.auto_ops import auto_ops_manager as _auto_ops_manager
    _auto_ops_manager.stop()
...
app.include_router(auto_ops_router, prefix="/api")
