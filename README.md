...
xyautofree 是一个以 ChatGPT free 账号注册、管理和本地配置为主的 Web 面板。当前公开前端侧栏只暴露三个顶层入口：`总览`、`chatgpt free`、`设置`。

---

## 推荐中转站 · [gguuai.com](https://gguuai.com)

> **稳定 API 中转 · 多模型接入**  
> 点击打开：**[https://gguuai.com](https://gguuai.com)**

## 加入 QQ 群（教程 / 交流）

扫码加入 QQ 群，获取使用教程与更多工具：

<p align="center">
  <img src="assets/qq-group.png" alt="QQ 群二维码" width="280" />
</p>
